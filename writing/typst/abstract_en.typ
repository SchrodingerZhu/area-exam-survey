#let abstract_en() = {
  ...
  text[
    ...
    This work examines prior research on the design and implementation of memory reuse runtime for functional programming languages. We conduct case studies on emerging languages like Lean4 and Koka. The work addresses how ownership semantics within these languages interact with memory reuse, alongside the static and runtime analysis required for effective reuse.
